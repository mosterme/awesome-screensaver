...
namespace awesomescr
{
    public class Settings : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            label_emoji.Location = new Point(label_x, 130);
            unicode_emoji.Location = new Point(check_x, label_emoji.Location.Y);
            label_maths.Location = new Point(label_x, 160);
            ...
            tabPage1.Controls.Add(label_emoji);
            tabPage1.Controls.Add(unicode_emoji);
            tabPage1.Controls.Add(label_maths);
            tabPage1.Controls.Add(unicode_maths);
            tabPage1.Controls.Add(label_other);
            tabPage1.Controls.Add(unicode_other);
