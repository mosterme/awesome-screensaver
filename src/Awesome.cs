...
namespace awesomescr
{
    public class Awesome : Provider
    {
        ...
        private static readonly Dictionary<int, string> data = new Dictionary<int, string>() {
            {0xf000,"Web Application Icons : fa-glass"},
            {0xf001,"Web Application Icons : fa-music"},
            {0xf002,"Web Application Icons : fa-search"},
            {0xf003,"Web Application Icons : fa-envelope-o"},
            {0xf004,"Medical Icons : fa-heart"},
            {0xf005,"Web Application Icons : fa-star"},
            {0xf006,"Web Application Icons : fa-star-o"},
            {0xf007,"Web Application Icons : fa-user"},
            {0xf008,"Web Application Icons : fa-film"},
            {0xf009,"Text Editor Icons : fa-th-large"},
            {0xf00a,"Text Editor Icons : fa-th"},
            {0xf00b,"Text Editor Icons : fa-th-list"},
            {0xf00c,"Web Application Icons : fa-check"},
            {0xf00d,"Web Application Icons : fa-times"},
            {0xf00e,"Web Application Icons : fa-search-plus"},
            {0xf010,"Web Application Icons : fa-search-minus"},
            {0xf011,"Web Application Icons : fa-power-off"},
            {0xf012,"Web Application Icons : fa-signal"},
            {0xf013,"Spinner Icons : fa-cog"},
            {0xf014,"Web Application Icons : fa-trash-o"},
            {0xf015,"Web Application Icons : fa-home"},
            {0xf016,"File Type Icons : fa-file-o"},
            {0xf017,"Web Application Icons : fa-clock-o"},
            {0xf018,"Web Application Icons : fa-road"},
            {0xf019,"Web Application Icons : fa-download"},
            {0xf01a,"Directional Icons : fa-arrow-circle-o-down"},
            {0xf01b,"Directional Icons : fa-arrow-circle-o-up"},
            {0xf01c,"Web Application Icons : fa-inbox"},
            ...
            {0xf023,"Web Application Icons : fa-lock"},
            {0xf024,"Web Application Icons : fa-flag"},
            {0xf025,"Web Application Icons : fa-headphones"},
            {0xf026,"Web Application Icons : fa-volume-off"},
            {0xf027,"Web Application Icons : fa-volume-down"},
            {0xf028,"Web Application Icons : fa-volume-up"},
            {0xf029,"Web Application Icons : fa-qrcode"},
            {0xf02a,"Web Application Icons : fa-barcode"},
            {0xf02b,"Web Application Icons : fa-tag"},
            {0xf02c,"Web Application Icons : fa-tags"},
            {0xf02d,"Web Application Icons : fa-book"},
            {0xf02e,"Web Application Icons : fa-bookmark"},
            {0xf02f,"Web Application Icons : fa-print"},
            {0xf030,"Web Application Icons : fa-camera"},
            ...
            {0xf03d,"Web Application Icons : fa-video-camera"},
            {0xf03e,"Web Application Icons : fa-picture-o"},
            {0xf040,"Web Application Icons : fa-pencil"},
            {0xf041,"Web Application Icons : fa-map-marker"},
            {0xf042,"Web Application Icons : fa-adjust"},
            {0xf043,"Web Application Icons : fa-tint"},
            {0xf044,"Web Application Icons : fa-pencil-square-o"},
            {0xf045,"Web Application Icons : fa-share-square-o"},
            ...
            {0xf055,"Web Application Icons : fa-plus-circle"},
            {0xf056,"Web Application Icons : fa-minus-circle"},
            {0xf057,"Web Application Icons : fa-times-circle"},
            {0xf058,"Web Application Icons : fa-check-circle"},
            {0xf059,"Accessibility Icons : fa-question-circle"},
            {0xf05a,"Web Application Icons : fa-info-circle"},
            {0xf05b,"Web Application Icons : fa-crosshairs"},
            {0xf05c,"Web Application Icons : fa-times-circle-o"},
            {0xf05d,"Web Application Icons : fa-check-circle-o"},
            {0xf05e,"Web Application Icons : fa-ban"},
            ...
            {0xf064,"Web Application Icons : fa-share"},
            {0xf065,"Video Player Icons : fa-expand"},
            {0xf066,"Video Player Icons : fa-compress"},
            {0xf067,"Web Application Icons : fa-plus"},
            {0xf068,"Web Application Icons : fa-minus"},
            {0xf069,"Web Application Icons : fa-asterisk"},
            {0xf06a,"Web Application Icons : fa-exclamation-circle"},
            {0xf06b,"Web Application Icons : fa-gift"},
            {0xf06c,"Web Application Icons : fa-leaf"},
            {0xf06d,"Web Application Icons : fa-fire"},
            {0xf06e,"Web Application Icons : fa-eye"},
            {0xf070,"Web Application Icons : fa-eye-slash"},
            {0xf071,"Web Application Icons : fa-exclamation-triangle"},
            {0xf072,"Transportation Icons : fa-plane"},
            {0xf073,"Web Application Icons : fa-calendar"},
            {0xf074,"Video Player Icons : fa-random"},
            {0xf075,"Web Application Icons : fa-comment"},
            {0xf076,"Web Application Icons : fa-magnet"},
            {0xf077,"Directional Icons : fa-chevron-up"},
            {0xf078,"Directional Icons : fa-chevron-down"},
            {0xf079,"Web Application Icons : fa-retweet"},
            {0xf07a,"Web Application Icons : fa-shopping-cart"},
            {0xf07b,"Web Application Icons : fa-folder"},
            {0xf07c,"Web Application Icons : fa-folder-open"},
            ...
            {0xf083,"Web Application Icons : fa-camera-retro"},
            {0xf084,"Web Application Icons : fa-key"},
            {0xf085,"Web Application Icons : fa-cogs"},
            {0xf086,"Web Application Icons : fa-comments"},
            {0xf087,"Hand Icons : fa-thumbs-o-up"},
            {0xf088,"Hand Icons : fa-thumbs-o-down"},
            {0xf089,"Web Application Icons : fa-star-half"},
            {0xf08a,"Medical Icons : fa-heart-o"},
            {0xf08b,"Web Application Icons : fa-sign-out"},
            {0xf08c,"Brand Icons : fa-linkedin-square"},
            {0xf08d,"Web Application Icons : fa-thumb-tack"},
            {0xf08e,"Web Application Icons : fa-external-link"},
            {0xf090,"Web Application Icons : fa-sign-in"},
            {0xf091,"Web Application Icons : fa-trophy"},
            {0xf092,"Brand Icons : fa-github-square"},
            {0xf093,"Web Application Icons : fa-upload"},
            {0xf094,"Web Application Icons : fa-lemon-o"},
            {0xf095,"Web Application Icons : fa-phone"},
            {0xf096,"Form Control Icons : fa-square-o"},
            {0xf097,"Web Application Icons : fa-bookmark-o"},
            {0xf098,"Web Application Icons : fa-phone-square"},
            {0xf099,"Brand Icons : fa-twitter"},
            {0xf09a,"Brand Icons : fa-facebook"},
            {0xf09b,"Brand Icons : fa-github"},
            {0xf09c,"Web Application Icons : fa-unlock"},
            {0xf09d,"Payment Icons : fa-credit-card"},
            {0xf09e,"Web Application Icons : fa-rss"},
            {0xf0a0,"Web Application Icons : fa-hdd-o"},
            {0xf0a1,"Web Application Icons : fa-bullhorn"},
            {0xf0a2,"Web Application Icons : fa-bell-o"},
            {0xf0a3,"Web Application Icons : fa-certificate"},
            ...
            {0xf0ac,"Web Application Icons : fa-globe"},
            {0xf0ad,"Web Application Icons : fa-wrench"},
            {0xf0ae,"Web Application Icons : fa-tasks"},
            {0xf0b0,"Web Application Icons : fa-filter"},
            {0xf0b1,"Web Application Icons : fa-briefcase"},
            {0xf0b2,"Video Player Icons : fa-arrows-alt"},
            {0xf0c0,"Web Application Icons : fa-users"},
            {0xf0c1,"Web Application Icons : fa-link"},
            {0xf0c2,"Web Application Icons : fa-cloud"},
            {0xf0c3,"Web Application Icons : fa-flask"},
            ...
            {0xf0c9,"Web Application Icons : fa-bars"},
            ...
            {0xf0d0,"Web Application Icons : fa-magic"},
            ...
            {0xf0dc,"Web Application Icons : fa-sort"},
            {0xf0dd,"Web Application Icons : fa-sort-desc"},
            {0xf0de,"Web Application Icons : fa-sort-asc"},
            {0xf0e0,"Web Application Icons : fa-envelope"},
            {0xf0e1,"Brand Icons : fa-linkedin"},
            {0xf0e2,"Text Editor Icons : fa-undo"},
            {0xf0e3,"Web Application Icons : fa-gavel"},
            {0xf0e4,"Web Application Icons : fa-tachometer"},
            {0xf0e5,"Web Application Icons : fa-comment-o"},
            {0xf0e6,"Web Application Icons : fa-comments-o"},
            {0xf0e7,"Web Application Icons : fa-bolt"},
            {0xf0e8,"Web Application Icons : fa-sitemap"},
            {0xf0e9,"Web Application Icons : fa-umbrella"},
            {0xf0ea,"Text Editor Icons : fa-clipboard"},
            {0xf0eb,"Web Application Icons : fa-lightbulb-o"},
            {0xf0ec,"Directional Icons : fa-exchange"},
            {0xf0ed,"Web Application Icons : fa-cloud-download"},
            {0xf0ee,"Web Application Icons : fa-cloud-upload"},
            {0xf0f0,"Medical Icons : fa-user-md"},
            {0xf0f1,"Medical Icons : fa-stethoscope"},
            {0xf0f2,"Web Application Icons : fa-suitcase"},
            {0xf0f3,"Web Application Icons : fa-bell"},
            {0xf0f4,"Web Application Icons : fa-coffee"},
            {0xf0f5,"Web Application Icons : fa-cutlery"},
            {0xf0f6,"File Type Icons : fa-file-text-o"},
            {0xf0f7,"Web Application Icons : fa-building-o"},
            {0xf0f8,"Medical Icons : fa-hospital-o"},
            {0xf0f9,"Medical Icons : fa-ambulance"},
            {0xf0fa,"Medical Icons : fa-medkit"},
            {0xf0fb,"Transportation Icons : fa-fighter-jet"},
            {0xf0fc,"Web Application Icons : fa-beer"},
            {0xf0fd,"Medical Icons : fa-h-square"},
            ...
            {0xf108,"Web Application Icons : fa-desktop"},
            {0xf109,"Web Application Icons : fa-laptop"},
            {0xf10a,"Web Application Icons : fa-tablet"},
            {0xf10b,"Web Application Icons : fa-mobile"},
            {0xf10c,"Form Control Icons : fa-circle-o"},
            {0xf10d,"Web Application Icons : fa-quote-left"},
            {0xf10e,"Web Application Icons : fa-quote-right"},
            {0xf110,"Spinner Icons : fa-spinner"},
            {0xf111,"Form Control Icons : fa-circle"},
            {0xf112,"Web Application Icons : fa-reply"},
            {0xf113,"Brand Icons : fa-github-alt"},
            {0xf114,"Web Application Icons : fa-folder-o"},
            {0xf115,"Web Application Icons : fa-folder-open-o"},
            {0xf118,"Web Application Icons : fa-smile-o"},
            {0xf119,"Web Application Icons : fa-frown-o"},
            {0xf11a,"Web Application Icons : fa-meh-o"},
            {0xf11b,"Web Application Icons : fa-gamepad"},
            {0xf11c,"Web Application Icons : fa-keyboard-o"},
            {0xf11d,"Web Application Icons : fa-flag-o"},
            {0xf11e,"Web Application Icons : fa-flag-checkered"},
            {0xf120,"Web Application Icons : fa-terminal"},
            {0xf121,"Web Application Icons : fa-code"},
            {0xf122,"Web Application Icons : fa-reply-all"},
            {0xf123,"Web Application Icons : fa-star-half-o"},
            {0xf124,"Web Application Icons : fa-location-arrow"},
            {0xf125,"Web Application Icons : fa-crop"},
            {0xf126,"Web Application Icons : fa-code-fork"},
            {0xf127,"Text Editor Icons : fa-chain-broken"},
            {0xf128,"Web Application Icons : fa-question"},
            {0xf129,"Web Application Icons : fa-info"},
            {0xf12a,"Web Application Icons : fa-exclamation"},
            {0xf12b,"Text Editor Icons : fa-superscript"},
            {0xf12c,"Text Editor Icons : fa-subscript"},
            {0xf12d,"Text Editor Icons : fa-eraser"},
            {0xf12e,"Web Application Icons : fa-puzzle-piece"},
            {0xf130,"Web Application Icons : fa-microphone"},
            {0xf131,"Web Application Icons : fa-microphone-slash"},
            {0xf132,"Web Application Icons : fa-shield"},
            {0xf133,"Web Application Icons : fa-calendar-o"},
            {0xf134,"Web Application Icons : fa-fire-extinguisher"},
            ...
            {0xf13d,"Web Application Icons : fa-anchor"},
            {0xf13e,"Web Application Icons : fa-unlock-alt"},
            {0xf140,"Web Application Icons : fa-bullseye"},
            {0xf141,"Web Application Icons : fa-ellipsis-h"},
            {0xf142,"Web Application Icons : fa-ellipsis-v"},
            {0xf143,"Web Application Icons : fa-rss-square"},
            {0xf144,"Video Player Icons : fa-play-circle"},
            {0xf145,"Web Application Icons : fa-ticket"},
            {0xf146,"Form Control Icons : fa-minus-square"},
            {0xf147,"Form Control Icons : fa-minus-square-o"},
            {0xf148,"Web Application Icons : fa-level-up"},
            {0xf149,"Web Application Icons : fa-level-down"},
            {0xf14a,"Form Control Icons : fa-check-square"},
            {0xf14b,"Web Application Icons : fa-pencil-square"},
            {0xf14c,"Web Application Icons : fa-external-link-square"},
            {0xf14d,"Web Application Icons : fa-share-square"},
            {0xf14e,"Web Application Icons : fa-compass"},
            ...
            {0xf15d,"Web Application Icons : fa-sort-alpha-asc"},
            {0xf15e,"Web Application Icons : fa-sort-alpha-desc"},
            {0xf160,"Web Application Icons : fa-sort-amount-asc"},
            {0xf161,"Web Application Icons : fa-sort-amount-desc"},
            {0xf162,"Web Application Icons : fa-sort-numeric-asc"},
            {0xf163,"Web Application Icons : fa-sort-numeric-desc"},
            ...
            {0xf182,"Web Application Icons : fa-female"},
            {0xf183,"Web Application Icons : fa-male"},
            {0xf184,"Brand Icons : fa-gratipay"},
            {0xf185,"Web Application Icons : fa-sun-o"},
            {0xf186,"Web Application Icons : fa-moon-o"},
            {0xf187,"Web Application Icons : fa-archive"},
            {0xf188,"Web Application Icons : fa-bug"},
            ...
            {0xf199,"Web Application Icons : fa-envelope-square"},
            {0xf19a,"Brand Icons : fa-wordpress"},
            {0xf19b,"Brand Icons : fa-openid"},
            {0xf19c,"Web Application Icons : fa-university"},
            {0xf19d,"Web Application Icons : fa-graduation-cap"},
            ...
            {0xf1ab,"Web Application Icons : fa-language"},
            {0xf1ac,"Web Application Icons : fa-fax"},
            {0xf1ad,"Web Application Icons : fa-building"},
            {0xf1ae,"Web Application Icons : fa-child"},
            {0xf1b0,"Web Application Icons : fa-paw"},
            {0xf1b1,"Web Application Icons : fa-spoon"},
            {0xf1b2,"Web Application Icons : fa-cube"},
            {0xf1b3,"Web Application Icons : fa-cubes"},
            ...
            {0xf1cd,"Web Application Icons : fa-life-ring"},
            ...
            {0xf1d8,"Web Application Icons : fa-paper-plane"},
            {0xf1d9,"Web Application Icons : fa-paper-plane-o"},
            {0xf1da,"Web Application Icons : fa-history"},
            {0xf1db,"Web Application Icons : fa-circle-thin"},
            {0xf1dc,"Text Editor Icons : fa-header"},
            {0xf1dd,"Text Editor Icons : fa-paragraph"},
            {0xf1de,"Web Application Icons : fa-sliders"},
            {0xf1e0,"Web Application Icons : fa-share-alt"},
            {0xf1e1,"Web Application Icons : fa-share-alt-square"},
            {0xf1e2,"Web Application Icons : fa-bomb"},
            {0xf1e3,"Web Application Icons : fa-futbol-o"},
            {0xf1e4,"Accessibility Icons : fa-tty"},
            {0xf1e5,"Web Application Icons : fa-binoculars"},
            {0xf1e6,"Web Application Icons : fa-plug"},
            {0xf1e7,"Brand Icons : fa-slideshare"},
            {0xf1e8,"Brand Icons : fa-twitch"},
            {0xf1e9,"Brand Icons : fa-yelp"},
            {0xf1ea,"Web Application Icons : fa-newspaper-o"},
            {0xf1eb,"Web Application Icons : fa-wifi"},
            {0xf1ec,"Web Application Icons : fa-calculator"},
            ...
            {0xf1f6,"Web Application Icons : fa-bell-slash"},
            {0xf1f7,"Web Application Icons : fa-bell-slash-o"},
            {0xf1f8,"Web Application Icons : fa-trash"},
            {0xf1f9,"Web Application Icons : fa-copyright"},
            {0xf1fa,"Web Application Icons : fa-at"},
            {0xf1fb,"Web Application Icons : fa-eyedropper"},
            {0xf1fc,"Web Application Icons : fa-paint-brush"},
            {0xf1fd,"Web Application Icons : fa-birthday-cake"},
            ...
            {0xf204,"Web Application Icons : fa-toggle-off"},
            {0xf205,"Web Application Icons : fa-toggle-on"},
            ...
            {0xf217,"Web Application Icons : fa-cart-plus"},
            {0xf218,"Web Application Icons : fa-cart-arrow-down"},
            {0xf219,"Web Application Icons : fa-diamond"},
            {0xf21a,"Transportation Icons : fa-ship"},
            {0xf21b,"Web Application Icons : fa-user-secret"},
            {0xf21c,"Transportation Icons : fa-motorcycle"},
            {0xf21d,"Web Application Icons : fa-street-view"},
            {0xf21e,"Medical Icons : fa-heartbeat"},
            ...
            {0xf233,"Web Application Icons : fa-server"},
            {0xf234,"Web Application Icons : fa-user-plus"},
            {0xf235,"Web Application Icons : fa-user-times"},
            {0xf236,"Web Application Icons : fa-bed"},
            ...
            {0xf240,"Web Application Icons : fa-battery-full"},
            {0xf241,"Web Application Icons : fa-battery-three-quarters"},
            {0xf242,"Web Application Icons : fa-battery-half"},
            {0xf243,"Web Application Icons : fa-battery-quarter"},
            {0xf244,"Web Application Icons : fa-battery-empty"},
            {0xf245,"Web Application Icons : fa-mouse-pointer"},
            {0xf246,"Web Application Icons : fa-i-cursor"},
            {0xf247,"Web Application Icons : fa-object-group"},
            {0xf248,"Web Application Icons : fa-object-ungroup"},
            {0xf249,"Web Application Icons : fa-sticky-note"},
            {0xf24a,"Web Application Icons : fa-sticky-note-o"},
            {0xf24b,"Payment Icons : fa-cc-jcb"},
            {0xf24c,"Payment Icons : fa-cc-diners-club"},
            {0xf24d,"Web Application Icons : fa-clone"},
            {0xf24e,"Web Application Icons : fa-balance-scale"},
            {0xf250,"Web Application Icons : fa-hourglass-o"},
            {0xf251,"Web Application Icons : fa-hourglass-start"},
            {0xf252,"Web Application Icons : fa-hourglass-half"},
            {0xf253,"Web Application Icons : fa-hourglass-end"},
            {0xf254,"Web Application Icons : fa-hourglass"},
            ...
            {0xf25c,"Web Application Icons : fa-trademark"},
            {0xf25d,"Web Application Icons : fa-registered"},
            {0xf25e,"Web Application Icons : fa-creative-commons"},
            ...
            {0xf26c,"Web Application Icons : fa-television"},
            {0xf26d,"Brand Icons : fa-contao"},
            {0xf26e,"Brand Icons : fa-500px"},
            {0xf270,"Brand Icons : fa-amazon"},
            {0xf271,"Web Application Icons : fa-calendar-plus-o"},
            {0xf272,"Web Application Icons : fa-calendar-minus-o"},
            {0xf273,"Web Application Icons : fa-calendar-times-o"},
            {0xf274,"Web Application Icons : fa-calendar-check-o"},
            {0xf275,"Web Application Icons : fa-industry"},
            {0xf276,"Web Application Icons : fa-map-pin"},
            {0xf277,"Web Application Icons : fa-map-signs"},
            {0xf278,"Web Application Icons : fa-map-o"},
            {0xf279,"Web Application Icons : fa-map"},
            {0xf27a,"Web Application Icons : fa-commenting"},
            {0xf27b,"Web Application Icons : fa-commenting-o"},
            ...
            {0xf290,"Web Application Icons : fa-shopping-bag"},
            {0xf291,"Web Application Icons : fa-shopping-basket"},
            {0xf292,"Web Application Icons : fa-hashtag"},
            {0xf293,"Brand Icons : fa-bluetooth"},
            {0xf294,"Brand Icons : fa-bluetooth-b"},
            {0xf295,"Web Application Icons : fa-percent"},
            ...
            {0xf2a5,"Web Application Icons : fa-glide"},
            {0xf2a6,"Web Application Icons : fa-glide-g"},
            ...
            {0xf2b5,"Web Application Icons : fa-handshake-o"},
            {0xf2b6,"Web Application Icons : fa-envelope-open"},
            {0xf2b7,"Web Application Icons : fa-envelope-open-o"},
            {0xf2b8,"Brand Icons : fa-linode"},
            {0xf2b9,"Web Application Icons : fa-address-book"},
            {0xf2ba,"Web Application Icons : fa-address-book-o"},
            {0xf2bb,"Web Application Icons : fa-address-card"},
            {0xf2bc,"Web Application Icons : fa-address-card-o"},
            {0xf2bd,"Web Application Icons : fa-user-circle"},
            {0xf2be,"Web Application Icons : fa-user-circle-o"},
            {0xf2c0,"Web Application Icons : fa-user-o"},
            {0xf2c1,"Web Application Icons : fa-id-badge"},
            {0xf2c2,"Web Application Icons : fa-id-card"},
            {0xf2c3,"Web Application Icons : fa-id-card-o"},
            {0xf2c4,"Brand Icons : fa-quora"},
            {0xf2c5,"Brand Icons : fa-free-code-camp"},
            {0xf2c6,"Brand Icons : fa-telegram"},
            {0xf2c7,"Web Application Icons : fa-thermometer-full"},
            {0xf2c8,"Web Application Icons : fa-thermometer-three-quarters"},
            {0xf2c9,"Web Application Icons : fa-thermometer-half"},
            {0xf2ca,"Web Application Icons : fa-thermometer-quarter"},
            {0xf2cb,"Web Application Icons : fa-thermometer-empty"},
            {0xf2cc,"Web Application Icons : fa-shower"},
            {0xf2cd,"Web Application Icons : fa-bath"},
            {0xf2ce,"Web Application Icons : fa-podcast"},
            {0xf2d0,"Web Application Icons : fa-window-maximize"},
            {0xf2d1,"Web Application Icons : fa-window-minimize"},
            {0xf2d2,"Web Application Icons : fa-window-restore"},
            {0xf2d3,"Web Application Icons : fa-window-close"},
            {0xf2d4,"Web Application Icons : fa-window-close-o"},
            ...
            {0xf2db,"Web Application Icons : fa-microchip"},
            {0xf2dc,"Web Application Icons : fa-snowflake-o"},
